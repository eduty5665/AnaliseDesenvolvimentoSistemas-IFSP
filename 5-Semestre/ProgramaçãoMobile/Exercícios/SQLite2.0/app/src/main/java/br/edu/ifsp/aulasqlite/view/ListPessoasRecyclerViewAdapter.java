...
public class ListPessoasRecyclerViewAdapter
        extends RecyclerView.Adapter<ListPessoasRecyclerViewAdapter.ViewHolder> {
    ...
    public void setClickListener(OnItemClickListerner listener) {
